...
b_lower_red = np.array([0, 128, 147])
b_upper_red = np.array([8,255,191])
b_lower_green = np.array([46,50,0])
b_upper_green = np.array([86,255,255])
b_lower_blue = np.array([103,32,0])
b_upper_blue = np.array([151,189,191])
b_lower_white = np.array([0,0,0])
b_upper_white = np.array([179,38,255])
b_lower_yellow = np.array([23,95,118])
b_upper_yellow = np.array([45,255,221])
